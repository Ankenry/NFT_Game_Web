...
// import Web3 from 'web3';
// export const getWeb3Install = async env => {
//   // if (env == "development") {
//   //     // For dev only
//   //     return new Web3(new Web3.providers.HttpProvider('https://empty-radial-snow.bsc-testnet.discover.quiknode.pro/7ec514e29948c7d734c284aa91a56d26fba20d32/'));
//   //     // End For dev only
//   // } else {
